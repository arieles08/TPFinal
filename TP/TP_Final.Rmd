...
<img src="https://drive.google.com/file/d/1sJbupZdzX4LaI7JKZ6pwag5vwpQLYYhp/view?usp=share_link" alt="JuveR" width="300px">
<img src="https://drive.google.com/file/d/1wjKODH0hvvWtWmRUdwS0UDtvAI4l_3Y2/view?usp=share_link" alt="JuveR" width="300px">

#### Predict_parts


Primero se selecciona una nueva observación del test_data. En este caso un barrio de Puerto Madero, de 90 metros cuadrados cubiertos, 55 descubiertos, con 3 habitaciones y 2 baños. 
```{r}
...
data_train_l3_Balvanera$l3_Balvanera<-variable_y$l3_Balvanera # Se coloca el valor de la variable l3_Puerto madero de la nueva obvervación en todos los datos del data train
...
Se puede determinar el orden de las variables manualmente utilizando el parámetro "order". En este ejemplo al cambiar el orden de las variables cambia el valor de la contribuciones. Por lo tanto es aconsejable utilizar ibreakdown que tienen en cuenta las iteraciones entre variables. 
...
El orden de las variables lo realiza de forma similar a BreakDown, lo único diferente es que tiene en cuenta la iteración entre variables cuando el score de la iteración es mayor al de las variables por separado y a la suma de las misma. Para que se entienda vamos a comparar los valores del score de las variables que tienen iteración que es el caso de superficie cubierta y baño. 
