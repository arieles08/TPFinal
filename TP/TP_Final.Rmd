...
El orden de las variables lo realiza de forma similar a BreakDown, lo único diferente es que tiene en cuenta una iteración entre variables cuando la score de la iteración es mayor al de las variables por separado y a la suma de las misma. Para que se entienda vamos a comparar los valores del score de las variables que tienen iteración que es el caso de superficie cubierta y baño. 
