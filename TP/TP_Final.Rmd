...
```
Como es más alto el valor de la iteración que cada variable individual y su suma, solamamente se representa la iteración entre superficie cubierta y baño. Individualmente no se representan. 
