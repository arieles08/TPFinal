...
-   $\hat{\beta_o}$ : (categoría basal de la variable categórica): es la
    media del precio para las casas de abasto sin superficie, sin baño y
    sin habitaciones
-   $\hat{\beta_{surface\_covered}}$ : es la pendiente de incremento de
    precio por superficie para cada tipo de barrio y tipo de propiedad
-   $\hat{\beta_{surface\_uncovered}}$ : es la pendiente de incremento
    de precio por superficie descubierta para cada tipo de barrio y tipo
    de propiedad
-   $\hat{\beta_{tipo\_barrioprecio\_bajo}}$ : es la diferencia en los
    niveles medios de precios de los barrios de precio bajos respecto de
    los barrios de precio alto (categoría basal)
-   $\hat{\beta_{tipo\_barrioprecio\_medio}}$ : es la diferencia en los
    niveles medios de precios de los barrios de precio medios respecto
    de los barrios de precio alto (categoría basal)
...
```
```{r}
mean(pred_randomForest[variables_test$l3 == "Puerto Madero"]
```
